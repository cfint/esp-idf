...
#ifdef CONFIG_BT_BTC_TASK_PINNED_TO_CORE
#define UC_BTC_TASK_PINNED_TO_CORE          (CONFIG_BT_BTC_TASK_PINNED_TO_CORE < portNUM_PROCESSORS ? CONFIG_BT_BTC_TASK_PINNED_TO_CORE : tskNO_AFFINITY)
#else
#define UC_BTC_TASK_PINNED_TO_CORE              (0)
#endif
